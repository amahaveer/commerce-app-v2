"use client"; // Required for Next.js to handle dynamic behavior
  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <mask id="mask0_1211_583" maskUnits="userSpaceOnUse" x="0" y="0" width="31" height="30">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
...
const Feature = () => {
  return (
    <section className="py-10 px-4 bg-white">
      <div className="container mx-auto px-4 py-8 border border-[#e9eaec] flex justify-center">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature) => (
            ...
            >
              ...
              <div>
                <h3 className="font-medium text-[16px] leading-[20px] text-[#010f1c] mb-[2px]">
                  {feature.title}
                </h3>
