...
import {
  ...
  ShippingMethod,
  Order,
} from '../../../../global-types/src/types/cart';
...
import { PaginatedResult } from '../../../../global-types/src/types/result';
...
export type CartActions = {
  ...
  addDeliveryToOrder: AddOrderDeliveryAction;
};
...
export const getCartActions = (
  ...
  return {
    ...
    addDeliveryToOrder: async (
      payload: AddOrderDeliveryPayload,
      options: { serverOptions?: ServerOptions } = {},
    ) => {
      const response = await sdk.callAction<Cart>({
        actionName: 'cart/addDeliveryToOrder',
        payload,
        serverOptions: options.serverOptions,
      });
      ...
      if (response.isError === false) {
        // sdk.trigger(
        //   new Event({
        //     eventName: 'orderDeliveryUpdated',
        //     data: {
        //       orderDelivery: response.data,
        //     },
        //   }),
        // );
      }
